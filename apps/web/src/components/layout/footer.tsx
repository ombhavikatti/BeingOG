...
// ─── Inline brand icons (Lucide 1.0 removed brand icons) ───
...
const socials = [
  { Icon: GithubIcon, href: "https://github.com/ombhavikatti/BeingOG", label: "GitHub" },
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        <div className="grid gap-12 md:grid-cols-6">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-text-secondary leading-relaxed">
              The operating system for ambitious students. Built with obsession
              in India 🇮🇳
            </p>
            ...
            <div className="mt-6 flex items-center gap-2">
              {socials.map((social) => (
                <Link
                  ...
                  className="grid h-9 w-9 place-items-center rounded-lg border border-border bg-surface text-text-secondary hover:text-primary-600 hover:border-primary-300 transition-colors"
                >
          ...
          {linkGroups.map((group) => (
            <div key={group.title}>
              <h3 className="font-mono text-xs font-semibold uppercase tracking-widest text-text-primary">
                {group.title}
              </h3>
        ...
        <div className="mt-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-t border-border pt-8">
          <p className="text-xs text-text-muted">
            © {new Date().getFullYear()} BeingOG. All rights reserved.
          </p>
